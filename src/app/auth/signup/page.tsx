...
const SignUp: React.FC = () => {
  ...
  return (
    <main className="flex justify-center items-center w-screen">
      <div className="rounded-sm border w-10/12 border-stroke my-3 bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
            <Link className="mb-5.5 inline-block" href="https://cirugiascuanticas.com">
                <Image
                  src={"/images/logo/cirugias.png"}
                  alt="Logo"
                  width={300}
                  height={32}
                />
              ...
              <form onSubmit={(e) => handleSignup(e, setStatus, setValidatedData)}>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Crear cuenta"
                    className="w-full cursor-pointer rounded-lg border border-yellow-500 bg-yellow-500 p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
