          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
...

              {
                ...
                <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("database")
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          
                          {
                            ...
                            <li>
                              <Link
                                href="/admin/database/mis-estudiantes"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/" && "text-white"
                                }`}
                              >
                            ...
                            <li>
                              <Link
                                href="/admin/database/mis-cursos"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/" && "text-white"
                                }`}
                              >
                            ...
                            <li>
                              <Link
                                href="/admin/database/lista-estudiantes"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/" && "text-white"
                                }`}
                              >
                            ...
                            <li>
                              <Link
                                href="/admin/database/facilitadores"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/" && "text-white"
                                }`}
                              >
